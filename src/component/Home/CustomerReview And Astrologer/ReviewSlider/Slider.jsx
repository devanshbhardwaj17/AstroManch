  ...
  function Star({ filled }) {
    return (
      <span className={filled ? "text-[#ff7821] text-2xl" : "text-gray-500 text-2xl"}>
        ★
      </span>
    );
  }
  ...
  export default function Slider() {
    ...
    return (
      <div className="flex items-center justify-center p-4 w-ful overflow-hidden">
        {/* Slider Container */}
        <div className="relative w-[320px] h-[450px] bg-white flex items-center rounded-2xl overflow-hidden shadow-lg border-gray-500 border-2 transition-transform duration-300 ease-in-out hover:scale-105">
